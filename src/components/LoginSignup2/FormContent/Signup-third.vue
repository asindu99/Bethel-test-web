            ...
            <!-- email div -->
                ...
                <div class="flex w-full justify-center mt-4 lg:flex-col md:flex-col sm:flex-col min-[320px]:flex-col  lg:px-10 md:px-40 sm:px-10 gap-y-12">
                    ...
                    <div class="flex flex-col relative lg:mt-0 md:mt-0 sm:mt-4 min-[320px]:mt-5">
                        ...
                        <vee-field autocomplete="off" id="username" name="username" type="text" class="w-full h-10 pl-2 text-gray-900 placeholder-transparent border-b-2 border-sidebarBG bg-blue-50 focus:outline-none focus:borer-rose-600 on:focus:bg-white" placeholder="username" />
...
export default{
    ...
    methods : {
        onReg(values){
            console.log(values)
            this.authUserStore.postAuthUserData(values);
        }
    }
