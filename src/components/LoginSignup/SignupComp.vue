        ...
        <div class="lg:h-[600px] lg:bg-[#FDFDFD] lg:basis-1/2 lg:rounded-r-xl">
            ...
            <div>
                ...
                <div>
                    ...
                    <div class="lg:m-10">
                        <p class="lg:font-[montserrat] lg:text-[13px] lg:text-center lg:text-[14px]"> <span>Already have an account?</span> <RouterLink to="/login" class="lg:text-[#293793] lg:cursor-pointer">Sign in Instead</RouterLink> </p>
                    </div>
                </div>
            </div>
